...
<head>
    ...
    <style>
        ...
        .model-toutiao-outsideApplication{
            background-color: #F69C5A;color: white;
        }
        .model-toutiao-outsideApplication:hover{
...
<div class="app">
    <div class="middle">
        <span class="h2 text-warning model-title">今日头条刷访问量</span>
        <div class="model-content">
            <div class="model-function model-toutiao-outsideApplication text-center">
                <a href="<c:url value="/"/>media/toutiao/singleurl" style="display: inline-block;color:white;text-decoration: none;" class="function-description text-center">应用外文章访问量</a>
            </div>
